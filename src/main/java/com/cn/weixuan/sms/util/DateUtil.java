package com.cn.weixuan.sms.util;
...
//		log.info(toString(getTheMonthLastDay(new Date()), "yyyy-MM-dd HH:mm:ss"));
//		log.info(toString(getLastMonthLastDay(), "yyyy-MM-dd HH:mm:ss"));
//		log.info(toString(getNowMonthFirstDay(), "yyyy-MM-dd HH:mm:ss"));
//		log.info(toString(getNowMonthLastDay(), "yyyy-MM-dd HH:mm:ss"));
	}
